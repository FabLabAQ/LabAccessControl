 ...
 *
 *	Modified by Luca Anastasio
 *	Removed unnecessary code for the application
 */
...
// an attempt to disable compiler optimizations
static void * (* const volatile memset_ptr)(void *, int, size_t) = memset;

static void __attribute__((optimize("O0"))) mbedtls_platform_zeroize(void * p, size_t len)
{
	(memset_ptr)(p, 0, len);
}
